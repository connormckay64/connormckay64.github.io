...
-----
  ...
  about.html     The sport + Griffin Hall + the six coaches
  history.html   Timeline + past-results table
  gallery.html   Photo gallery (maps, past squads, race day)
...
Search the files for "[" to find them all. Key ones:
  ...
  • Coaches (about.html) — six profiles: names, roles, short bios.
  • Gallery (gallery.html) — drop photos into the frames and edit the
    captions under the "previous squads" images.
  • History (history.html) — the timeline and the results table.
  • Sponsors (sponsors.html) — tier prices and benefits.
...
to re-skin the whole site. The theme is a light "map paper" palette;
--ink is the page background and --paper is the text colour, so you can
flip the whole site light or dark from those two lines. If Griffin has
official colours, swap them in.
